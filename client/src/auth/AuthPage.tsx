...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-dvh bg-slate-50 dark:bg-slate-900 flex flex-col safe-y">
      {brand}

      <main className="flex-1 grid md:grid-cols-2 items-center mx-auto max-w-7xl w-full gap-8 safe-x">
        {/* Left column */}
